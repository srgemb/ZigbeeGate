...
#define ZB_RES_Pin GPIO_PIN_7
#define ZB_RES_GPIO_Port GPIOC
#define ZB_NET_Pin GPIO_PIN_8
#define ZB_NET_GPIO_Port GPIOC
#define ZB_RUN_Pin GPIO_PIN_9
...
#define TEST4_Pin GPIO_PIN_7
#define TEST4_GPIO_Port GPIOB
